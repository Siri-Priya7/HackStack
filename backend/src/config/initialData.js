export const schemaSql = `-- Voice-Based Inventory Management Database Schema
...
CREATE TABLE IF NOT EXISTS products (
    ...
    unit_size REAL NOT NULL DEFAULT 1.0,
    purchase_price REAL DEFAULT 0.0,
    selling_price REAL NOT NULL DEFAULT 0.0,
    min_stock_threshold REAL NOT NULL DEFAULT 10.0,
...
CREATE TABLE IF NOT EXISTS inventory (
    ...
    current_stock_base REAL NOT NULL DEFAULT 0.0,
    current_stock_display VARCHAR(100) DEFAULT '',
...
export const seedSql = `-- Seed Data for Multi-Tenant Voice Inventory System
